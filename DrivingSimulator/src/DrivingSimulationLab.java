...
public class DrivingSimulationLab {
    ...
    public static void toggleEngine() {
      isEngineOn = !isEngineOn;  // Change the engine state here
    }
    ...
    public static void accelerate() {
        ...
        if (isEngineOn && !gear.equals("P")) {
            ...
            System.out.println("Your Cannot accelerate right now");
        }
    }
    ...
    public static void brake() {
        ...
        if (isEngineOn && speed>5) {
            ...
            System.out.println("You cannot break right now!");
        }
    }
    ...
    public static void exitSimulation() {
        ...
        System.out.println("You are about to end the simulation");
